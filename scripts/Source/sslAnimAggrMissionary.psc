...
function LoadAnimation()
	...
	AddPositionStage(a2, "AggrMissionary_A2_S1", -86)
	AddPositionStage(a2, "AggrMissionary_A2_S2", -86)
	AddPositionStage(a2, "AggrMissionary_A2_S3", -86)
	AddPositionStage(a2, "AggrMissionary_A2_S4", -86)
