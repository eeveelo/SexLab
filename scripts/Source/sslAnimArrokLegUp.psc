...
function LoadAnimation()
	...
	AddPositionStage(a2, "Arrok_LegUp_A2_S1", 44, rotate = 180)
	AddPositionStage(a2, "Arrok_LegUp_A2_S2", 44, rotate = 180)
	AddPositionStage(a2, "Arrok_LegUp_A2_S3", 44, rotate = 180)
	AddPositionStage(a2, "Arrok_LegUp_A2_S4", 44, rotate = 180)
	AddPositionStage(a2, "Arrok_LegUp_A2_S5", 44, rotate = 180)
