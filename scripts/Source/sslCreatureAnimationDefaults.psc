...
function CanineDoggystyle(string eventName, string id, float argNum, form sender)
	...
	int a2 = AddPosition(Creature)
	AddPositionStage(a2, "Canine_Doggystyle_A2_S1", 45.0, rotate=180.0)
	AddPositionStage(a2, "Canine_Doggystyle_A2_S2", 45.0, rotate=180.0)
	AddPositionStage(a2, "Canine_Doggystyle_A2_S3", 45.0, rotate=180.0)
	AddPositionStage(a2, "Canine_Doggystyle_A2_S4", 45.0, rotate=180.0)
...
function CanineMissionary(string eventName, string id, float argNum, form sender)
	...
	int a2 = AddPosition(Creature)
	AddPositionStage(a2, "Canine_Missionary_A2_S1", 45.0, rotate=180.0)
	AddPositionStage(a2, "Canine_Missionary_A2_S2", 45.0, rotate=180.0)
	AddPositionStage(a2, "Canine_Missionary_A2_S3", 45.0, rotate=180.0)
	AddPositionStage(a2, "Canine_Missionary_A2_S4", 45.0, rotate=180.0)
