...
int function GetEnjoyment()
	...
	elseif !IsSkilled
		...
		if Position == 0
			...
			Thread.SetBonuses()
		endIf
		Enjoyment = BaseEnjoyment + CalcEnjoyment(Thread.SkillBonus, Skills, Thread.LeadIn, IsFemale, (RealTime[0] - StartedAt), Stage, Animation.StageCount)
		if Enjoyment < 0
			Enjoyment = 0
